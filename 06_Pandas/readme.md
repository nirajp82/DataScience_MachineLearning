...
| Head & Tail             | Preview the first 5 or last 5 rows by default                               | `df.head()` / `df.tail()`             | DataFrame   | <pre>   A  B<br>0  1  3<br>1  2  4</pre>                                                                                                                                                                                                                                                         |
...
| Action                | Description                                             | Code Example                                                             | Output Type                                             | Example Output                                                                                                                                                                                                              |                                                                                             |
| --------------------- | ------------------------------------------------------- | ------------------------------------------------------------------------ | ------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| Unique values         | Return unique values from a column                      | `df['Department'].unique()`                                              | ndarray                                                 | <pre>['HR' 'IT' 'Finance']</pre>                                                                                                                                                                                            |                                                                                             |
| Number of unique vals | Count number of distinct values in a column             | `df['Department'].nunique()`                                             | int                                                     | <pre>3</pre>                                                                                                                                                                                                                |                                                                                             |
| Value counts          | Count frequency of unique values                        | `df['Department'].value_counts()`                                        | Series                                                  | <pre>IT         2<br>HR         1<br>Finance    1<br>Name: Department, dtype: int64</pre>                                                                                                                                   |                                                                                             |
| Conditional select    | Select rows based on a condition                        | `df[df['Salary'] > 60000]`                                               | DataFrame                                               | <pre>   EmployeeID   Name Department  Salary<br>2           103  Carol    Finance   70000<br>3           104   Dave        IT   90000</pre>                                                                                 |                                                                                             |
| Combined condition    | Select rows using multiple conditions with `&` (and), ` | ` (or)                                                                   | `df[(df['Salary'] > 60000) & (df['Department']=="IT")]` | DataFrame                                                                                                                                                                                                                   | <pre>   EmployeeID  Name Department  Salary<br>3          104  Dave        IT   90000</pre> |
| Apply custom func     | Apply a function to each value in a column              | `df['Salary'].apply(lambda x: x*1.1)`                                    | Series                                                  | <pre>0    55000.0<br>1    66000.0<br>2    77000.0<br>3    99000.0<br>Name: Salary, dtype: float64</pre>                                                                                                                     |                                                                                             |
| Drop a column         | Remove a column from the DataFrame                      | `df.drop('Department', axis=1)`                                          | DataFrame                                               | <pre>   EmployeeID   Name  Salary<br>0         101   Alice   50000<br>1         102     Bob   60000<br>2         103   Carol   70000<br>3         104    Dave   90000</pre>                                                 |                                                                                             |
| Column names          | Get list of column names                                | `df.columns`                                                             | Index                                                   | <pre>Index(['EmployeeID', 'Name', 'Department', 'Salary'], dtype='object')</pre>                                                                                                                                            |                                                                                             |
| Index names           | Get the index of the DataFrame                          | `df.index`                                                               | RangeIndex                                              | <pre>RangeIndex(start=0, stop=4, step=1)</pre>                                                                                                                                                                              |                                                                                             |
| Sort values           | Sort rows by column values                              | `df.sort_values(by='Salary')`                                            | DataFrame                                               | <pre>   EmployeeID   Name Department  Salary<br>0         101  Alice        HR   50000<br>1         102    Bob        IT   60000<br>2         103  Carol   Finance   70000<br>3         104   Dave        IT   90000</pre>  |                                                                                             |
| Null values check     | Check for missing (`NaN`) values                        | `df.isnull()`                                                            | DataFrame                                               | <pre>   EmployeeID   Name  Department  Salary<br>0      False  False      False   False<br>1      False  False      False   False<br>2      False  False      False   False<br>3      False  False      False   False</pre> |                                                                                             |
| Pivot table           | Create summary table with groupings and aggregation     | `df2.pivot_table(values='Salary', index='Department', columns='Gender')` | DataFrame                                               | <pre>Gender       F      M<br>Department             <br>Finance   70000.0    NaN<br>HR        50000.0    NaN<br>IT           NaN  75000.0</pre>                                                                            |                                                                                             |
